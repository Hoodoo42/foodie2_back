...
CREATE TABLE `client` (
  ...
  `salt` varchar(100) COLLATE utf8mb4_bin NOT NULL DEFAULT '23145',
  `password` varchar(150) COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `client_emailUN` (`email`),
...
(1,'email1@gmail.com','Billy','Johnston','user1','https://images.unsplash.com/photo-1495472987612-92395b142182?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2940&q=80','2022-10-28','23145','Qsc173vdW'),
(2,'email2@gmail.com','Bill','Jonston','user11','https://images.unsplash.com/photo-1495472987612-92395b142182?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2940&q=80','2022-10-28','23145','*B2FFA5FDEAAD40E5491E3DA299E554C256129309'),
(3,'email3@gmail.com','Billie','Jonson','user111','https://images.unsplash.com/photo-1495472987612-92395b142182?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2940&q=80','2022-10-28','23145','*5FCCAAAED751FFF74D2DDF86EB25CD2CE0D2D75A'),
(4,'email4@gmail.com','Billi','Johnson','user4','https://images.unsplash.com/photo-1541873676-a18131494184?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=836&q=80','2022-10-29','23145','*B4F81D08B39AC2B913695DEAFB1EF09254C4ACCF'),
(5,'email5@gmail.com','Billiegh','Jonnson','user5','https://images.unsplash.com/photo-1541873676-a18131494184?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=836&q=80','2022-10-30','23145','*30EE003A8D9887BD026C923ADCD30AA0C59437BA'),
(6,'delete@gmail.com','delete','delete','userdelete','https://images.unsplash.com/photo-1458966480358-a0ac42de0a7a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80','2022-10-30','23145','d31373');
...
CREATE TABLE `order_menu_item` (
  ...
  CONSTRAINT `order_menu_item_FK_1` FOREIGN KEY (`menu_item_id`) REFERENCES `old` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `restaurant` (
  ...
  `email` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `name` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `address` varchar(250) COLLATE utf8mb4_bin DEFAULT NULL,
  `city` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `phone_num` varchar(16) COLLATE utf8mb4_bin DEFAULT NULL,
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `client_create`(email_input varchar(100), first_name_input varchar(15), last_name_input varchar(30), username_input varchar(20), img_url_input varchar(500), password_input varchar(150))
    MODIFIES SQL DATA
BEGIN
	INSERT INTO client (email, first_name, last_name, username, img_url, password) 
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `client_get`(client_id_input int unsigned)
BEGIN
	SELECT id, CONVERT(email USING utf8), CONVERT(first_name USING utf8), CONVERT(last_name USING utf8), CONVERT(username USING utf8), img_url, created_at FROM client WHERE id = client_id_input;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	SELECT token_input, id FROM client WHERE email = email_input AND password = password_input;
	SELECT token, client_id FROM client_session cs WHERE token = token_input;
	COMMIT;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `client_order_create` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `client_order_get`(token_input varchar(100), confirmed_input tinyint(1), complete_input tinyint(1))
BEGIN
	SELECT o.is_confirmed, o.is_complete, mi.name , mi.price, omi.menu_item_id, omi.order_id 
	FROM `order` o INNER JOIN menu_item mi ON o.restaurant_id  = mi.restaurant_id 
	INNER JOIN order_menu_item omi ON mi.id = omi.menu_item_id 
	WHERE o.id = omi.order_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `client_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `client_update`(token_input varchar(100), email_input varchar(100), f_name_input varchar(15), l_name_input varchar(30), username varchar(20), img_input varchar(500), password_input varchar(150))
    MODIFIES SQL DATA
BEGIN
	UPDATE client SET email = email_input, first_name = f_name_input, last_name = l_name_input, username = username_input, img_url = img_input, password = PASSWORD(password_input)
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `menu_get`(restaurant_id_input int unsigned)
BEGIN
	SELECT name, description, img, price FROM menu_item WHERE restaurant_id = restaurant_id_input;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `menu_item_create` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `menu_item_delete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `menu_item_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `menu_item_update`(token_input varchar(100), menu_id_input int unsigned)
    MODIFIES SQL DATA
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `restaurant_create` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_create`(email_input varchar(100), name_input varchar(100), address_input varchar(250), city_input varchar(20), phone_num_input varchar(16), bio_input varchar(200), password_input varchar(150))
    MODIFIES SQL DATA
BEGIN
	INSERT INTO restaurant (email, name, address, city, phone_num, bio, password) VALUES (email_input, name_input, address_input, city_input, phone_num_input, bio_input, PASSWORD(password_input));
	SELECT ROW_COUNT();
	COMMIT;
END ;;
DELIMITER ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_delete`(token_input varchar(100), password_input varchar(150))
    MODIFIES SQL DATA
BEGIN
	DELETE FROM restaurant WHERE token = token_input AND password = password_input;
	SELECT ROW_COUNT();
	COMMIT;
END ;;
DELIMITER ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_get`(restaurant_id_input int unsigned)
BEGIN
	SELECT email, name, address, city, phone_num, bio FROM restaurant WHERE id = restaurant_id_input;
...
BEGIN
	...
	SELECT id, token_input FROM restaurant WHERE email = email_input AND password = password_input;
	SELECT ROW_COUNT();
	COMMIT;
END ;;
DELIMITER ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_order_get`(token_input varchar(100), confirmed_input tinyint(1), complete_input tinyint(1))
BEGIN
	SELECT o.is_confirmed, o.is_complete, mi.name , mi.price, omi.menu_item_id, omi.order_id 
	FROM `order` o INNER JOIN menu_item mi ON o.restaurant_id = mi.restaurant_id 
	INNER JOIN order_menu_item omi ON omi.menu_item_id = mi.id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `restaurant_order_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_order_update`(token_input varchar(100), order_id_input int unsigned, confirmed_input tinyint(1), complete_input tinyint(1))
    MODIFIES SQL DATA
BEGIN
	UPDATE `order` SET is_confirmed = confirmed_input, is_complete = complete_input
	WHERE `order`.id  = order_id_input;
	SELECT ROW_COUNT();
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `restaurant_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_update`(token_input varchar(100), email_input varchar(100), name_input varchar(100), address_input varchar(250), city_input varchar(20), phone_num_input varchar(16), bio_input varchar(200), password_input varchar(150))
    MODIFIES SQL DATA
BEGIN
	UPDATE restaurant SET email = email_input, name = name_input, address = address_input, city = city_input, phone_num = phone_num_input, bio = bio_input, password = password_update
	WHERE token = token_input;
	SELECT ROW_COUNT();
	COMMIT;
END ;;
